...
ifneq ($(FULIA_BUILD),)
include vendor/fulia/config/BoardConfigFulia.mk
endif
...
ifneq ($(FULIA_BUILD),)
ifneq ($(wildcard device/fulia/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/fulia/sepolicy/common/sepolicy.mk)
endif
endif
